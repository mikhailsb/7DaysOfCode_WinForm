...
namespace CatAsService.Models
{
    ...
    {
        [JsonProperty("weight")]
        public IDictionary<string, string> Weight { get; set; }
        ...
        public static List<Cat> Deserializer(string Json)
        {
            List<Cat> gatos = JsonConvert.DeserializeObject<List<Cat>>(Json);
            return gatos;
        }
    }
}
